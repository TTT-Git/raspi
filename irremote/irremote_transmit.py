...
# pwm = pwmio.PWMOut(board.D19, frequency=38000, duty_cycle=2 ** 15)
pulseout = pwmio.PWMOut(board.D19, frequency=38000, duty_cycle=2 ** 15)
# Create an encoder that will take numbers and turn them into NEC IR pulses
encoder = adafruit_irremote.GenericTransmit(
    header=[9500, 4500], one=[550, 550], zero=[550, 1700], trail=0, debug=True
)
